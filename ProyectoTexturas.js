...
iluminacionRoja.position.y = 30;
iluminacionRoja.position.x = -20;
iluminacionRoja.position.z = -20;

iluminacionVerde.position.y = 30;
iluminacionVerde.position.x = 20;
iluminacionVerde.position.z = -20;

iluminacionAzul.position.y = 30;
iluminacionAzul.position.z = 28.3;

THREE.ImageUtils.crossOrigin = '';

var escena = new THREE.Scene();
var textura = THREE.TextureLoader('https://luisestradab.github.io/brick_diffuse.jpg');
...
pieza.translate(80,10,-80);

var piezaMalla = new THREE.Mesh( pieza, materialN );
piezaMalla.scale.set(0.05,0.05,0.05);
...
Oruga.translate(-80,15,-35);
var OrugaM = new THREE.Mesh( Oruga, materialN );
OrugaM.scale.set(0.05,0.05,0.05);
...
forma.translate(0,10,-35);
var malla5 = new THREE.Mesh( forma, materialN );
malla5.scale.set(0.05,0.05,0.05);
...
formaE.translate(80,10,-35);

var mallaE = new THREE.Mesh( formaE, materialN );
mallaE.scale.set(0.05,0.05,0.05);


//-----------------------------------------------------------------


var piezaMalla2 = new THREE.Mesh( pieza, materialN );
piezaMalla2.rotation.y = Math.PI;
piezaMalla2.scale.set(0.05,0.05,0.05);

var malla12 = new THREE.Mesh( forma1, materialN );
malla12.rotation.y = Math.PI;
malla12.scale.set(0.05,0.05,0.05);

var malla22 = new THREE.Mesh( forma2, materialN );
malla22.rotation.y = Math.PI;
malla22.scale.set(0.05,0.05,0.05);

var OrugaM2 = new THREE.Mesh( Oruga, materialN );
OrugaM2.rotation.y = Math.PI;
OrugaM2.scale.set(0.05,0.05,0.05);

var malla52 = new THREE.Mesh( forma, materialN );
malla52.rotation.y = Math.PI;
malla52.scale.set(0.05,0.05,0.05);

var mallaE2 = new THREE.Mesh( formaE, materialN );
mallaE2.rotation.y = Math.PI;
mallaE2.scale.set(0.05,0.05,0.05);
...
malla1.castShadow = true;
malla12.castShadow = true;
...
malla5.castShadow = true;
malla52.castShadow = true;
