function setup(){
  ...
  raycaster1 = new THREE.Raycaster( pelota.position, new THREE.Vector3(0.5,0,0) );
  ...
  renderer.setSize( window.innerHeight*0.95,
...
function loop(){
  ...
  raycaster1.set( pelota.position, new THREE.Vector3(0.5,0,0) );
